error id: file:///C:/Projects/HES/MA-AdvProg/exo2/src/main/scala/exo2/DatasetLoader.scala:
file:///C:/Projects/HES/MA-AdvProg/exo2/src/main/scala/exo2/DatasetLoader.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -StandardCharsets.
	 -scala/Predef.StandardCharsets.
offset: 202
uri: file:///C:/Projects/HES/MA-AdvProg/exo2/src/main/scala/exo2/DatasetLoader.scala
text:
```scala
package exo2
...
object DatasetLoader {
  ...
  def load(path: String): Dataset=
    ...
    val lines = Source.fromFile(path, StandardCha@@rsets.UTF_8).getLines().drop(1)
